function similarCarousel (){
    let backBtn = document.querySelector('#similar-btn-back');
    let forwardBtn = document.querySelector('#similar-btn-forward');
    let carousel = document.querySelector('.card-main__similar-section__corousel__body');
    let products = document.querySelectorAll('.card-main__similar-section__corousel__body__itm');
    let scrollDots = document.querySelectorAll('.card-main__similar-section__corousel__progress__itm');
